                            ...
                            @if ( Route::has('login') )
                                @auth
                                    @if (Auth::user()->Utype == 'ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            <a title="My Acount" href="#">May Acount {{ \Illuminate\Support\Facades\Auth::user()->name }}<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                    ...
                                    @else
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                    <a title="Profile" href="{{route('user.dashboard')}}">Dashboard</a>
                                                </li>
                                                <form method="POST" action="{{route('logout')}}">
                                                    @csrf
                                                    <li class="menu-item" >
